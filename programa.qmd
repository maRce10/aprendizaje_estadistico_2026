...
::: {.alert .alert-info}
[Programa del curso en PDF](https://github.com/maRce10/aprendizaje_estadistico_2026/blob/master/programa_SP_3068_aprendizaje_de_maquinas.pdf)
:::
...
1.  (8 pts) Genere un conjunto de datos con 100 observaciones y 5 variables, donde una de ellas sea una variable categórica con 3 niveles. Cada variable cuantitativa debe ser generada con una distriución diferente (e.g. normal,log-normal, gamma, etc) 

2. (12 pts) Explore el Teorema del Límite Central utilizando:
 ...
 Para cada distribución: 
  ...
  - Grafique un histograma de la poblacion total
  - Grafique un histograma de los promedios de las muestras 
  - Compare los promedios de la población y de las muestras (¿Son similares?) 
