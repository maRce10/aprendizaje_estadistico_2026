...
load_packages(
  packages = c(
    ...
    # estadistica descriptiva / tradicional
    "psych",
    "car",
    "MASS",

    # modelos de regresion y mixtos
    "lme4",
    "lmerTest",
    "MuMIn",
    "sjPlot",
    ...
    # aprendizaje automatico / modelos predictivos
    "caret",
    "randomForest",
    "xgboost",
    "neuralnet",
    ...
    # paquete de github (no esta en CRAN)
    github = "hadley/emo"
  )
)
