...
kbl <- kableExtra::kable_styling(kbl, bootstrap_options = "striped", font_size = 38) |>
  kableExtra::column_spec(1, background = cols[5]) |>
  kableExtra::column_spec(2:4, background = cols[8])
...
kbl <- kableExtra::kable_styling(kbl, bootstrap_options = "striped", font_size = 38) |>
  kableExtra::column_spec(1, background = cols[6]) |>
  kableExtra::column_spec(2:4, background = cols[8])
